...
{
    /// <inheritdoc />
    public partial class InicialArreglado : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CursosCarreras", x => new { x.CursoId, x.CarreraId });
                    table.ForeignKey(
                        name: "FK_CursosCarreras_Carreras_CarreraId",
                        column: x => x.CarreraId,
                        principalTable: "Carreras",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CursosCarreras_Cursos_CursoId",
                        column: x => x.CursoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocenteCursos", x => new { x.DocenteId, x.CursoId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DocenteCursos_Docentes_DocenteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EstudiantesCarreras", x => new { x.EstudianteId, x.CarreraId });
                    table.ForeignKey(
                        name: "FK_EstudiantesCarreras_Carreras_CarreraId",
                        column: x => x.CarreraId,
                        principalTable: "Carreras",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EstudiantesCarreras_Estudiantes_EstudianteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CursosCarreras_CarreraId",
                table: "CursosCarreras",
                column: "CarreraId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EstudiantesCarreras_CarreraId",
